...
import com.esa.evsync.app.pages.TaskDetails.TaskDetailsViewModel
 ...
 */
class TaskDetailsMembersRCAdapter(
    private var members: ArrayList<UserModel>,
    private val viewMdoel: TaskDetailsViewModel
) : RecyclerView.Adapter<TaskDetailsMembersRCAdapter.ViewHolder>() {
